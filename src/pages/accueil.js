...
const Accueil = () => {
    return (<main className="accueilMain">
        ...
        <div className="accueilText">
            ...
            <p>DERNIÈRE MISE À JOUR (13/11/2022)<br/>*****
            <br/>Amélioration des infos de chaque pièce de collection dans sa propre page&nbsp;: carte 111 à 120 (époque
            Dangerous).</p>
            <p>PROCHAINES MISES À JOUR<br/>*****
            <br/>Amélioration des infos de chaque pièce de collection dans sa propre page&nbsp;: carte 121 à 253.
