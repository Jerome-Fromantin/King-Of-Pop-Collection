...
const Accueil = () => {
    return (<main className="accueilMain">
        ...
        <div className="accueilText">
            ...
            <br/>Amélioration des infos de chaque pièce de collection dans sa propre page&nbsp;: carte 56 à 70.</p>
            <p>PROCHAINES MISES À JOUR<br/>*****
            <br/>Amélioration des infos de chaque pièce de collection dans sa propre page&nbsp;: carte 71 à 253.
